  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid" style="background-color:powderblue;">
        <a class="navbar-brand" href="index.php">Raipur City Hospital</a>&nbsp;&nbsp;
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="eclinic.php">e-CLINIC</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="#">Liver Cirrhosis</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="login.php">Official</a>
            </li>
            <li class="nav-item">
          ...
          <a href="signup.php">
            <button class="btn btn-success" href="signup.php">SignUp</button></a>
