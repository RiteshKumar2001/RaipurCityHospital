...
<?php require 'foot.php' ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/gfg/vaccstatus.php" method="post">
        <input type="hidden" name="snoEdit" id="snoEdit">
            <div class="form-group mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="adhaarEdit" name="adhaarEdit">
              </div>
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="doseEdit" name="doseEdit">
              </div>
              <div class="mb-3">
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/gfg/vaccstatus.php?delete=${sno}`;
